...
public class ResearcherPerspectiveController {
    ...
    public String show(Model model) {
        ...
        List<IConcept> concepts = conceptManager.getTopConcepts().stream().filter(c -> c.getSearchCategories().contains(SearchCategory.RESEARCHER)).collect(Collectors.toList());
